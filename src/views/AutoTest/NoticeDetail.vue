<template>
  <div>
    <el-row>
      <el-col :span="3">消息导入巴拉巴拉</el-col>
      <el-col :span="3" :offset="1">执行时间</el-col>
      <el-col :span="3" :offset="1">执行人</el-col>
    </el-row>
    <div>测试报告</div>
...
<nav>
	<div class="nav-wrapper">
		...
		<span class='report-name'>演训API自动化测试报告</span>
		<span class='report-headline'></span>
		<ul id='nav-mobile' class='right hide-on-med-and-down nav-right'>
			<li>
                <a href='#!'>
                    <span class='label suite-start-time blue darken-3'>May 19, 2020 01:56:30 PM</span>
				</a>
			</li>
			<li>
                <a href='#!'>
	...
	<div id='charts-row' class='row nm-v nm-h'>
		<div class='col s12 m6 l6 np-h'>
			<div class='card-panel nm-v'>
				...
				<div class='block text-small'>
					<span class='tooltipped' data-position='top' data-tooltip='28.571%'><span class='strong'>2</span> test(s) passed</span>
				</div>
				<div class='block text-small'>
					<span class='strong tooltipped' data-position='top' data-tooltip='71.429%'>5</span> test(s) failed, <span class='strong tooltipped' data-position='top' data-tooltip='0%'>0</span> others
				</div>
			</div>
		</div>
		...
		<div class='col s12 m6 l6 np-h'>
			<div class='card-panel nm-v'>
				...
				<div class='block text-small'>
					<span class='tooltipped' data-position='top' data-tooltip='28.571%'><span class='strong'>2</span> step(s) passed</span>
				</div>
				<div class='block text-small'>
					<span class='strong tooltipped' data-position='top' data-tooltip='71.429%'>5</span> step(s) failed, <span class='strong tooltipped' data-position='top' data-tooltip='0%'>0</span> others
				</div>
			</div>
		</div>
			...
			<ul id='test-collection' class='test-collection'>
				...
				<li class='test displayed active  fail' status='fail' bdd='false' test-id='1'>
					<div class='test-heading'>
						<span class='test-name'>assertTest1</span>
						<span class='test-time'>May 19, 2020 01:56:30 PM</span>
						<span class='test-status right fail'>fail</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>May 19, 2020 01:56:30 PM</span>
	<span class='label end-time'>May 19, 2020 01:56:30 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 0s+77ms</span>
</div>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='fail'>
					...
					<td class='timestamp'>1:56:33 PM</td>
	...
	at com.dadalong.autotest.testng.AssertDemo.assertTest1(AssertDemo.java:11)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
				...
				<li class='test displayed active  fail' status='fail' bdd='false' test-id='2'>
					<div class='test-heading'>
						<span class='test-name'>logTest1</span>
						<span class='test-time'>May 19, 2020 01:56:30 PM</span>
						<span class='test-status right fail'>fail</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='debug'>
					...
					<td class='timestamp'>1:56:33 PM</td>
					<td class='step-details'>这是我们自己写的日志</td>
				</tr>
				<tr class='log' status='fail'>
					<td class='status fail' title='fail' alt='fail'><i class='material-icons'>cancel</i></td>
					<td class='timestamp'>1:56:33 PM</td>
					<td class='step-details'><pre>java.lang.RuntimeException: 自己运行时的异常
	at com.dadalong.autotest.testng.AssertDemo.logTest1(AssertDemo.java:27)
	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:62)
	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
	at java.lang.reflect.Method.invoke(Method.java:498)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
				...
				<li class='test displayed active  fail' status='fail' bdd='false' test-id='3'>
					<div class='test-heading'>
						<span class='test-name'>testGet2HttpClient</span>
						<span class='test-time'>May 19, 2020 01:56:30 PM</span>
						<span class='test-status right fail'>fail</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>May 19, 2020 01:56:30 PM</span>
	<span class='label end-time'>May 19, 2020 01:56:32 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 2s+74ms</span>
</div>
	<div class='test-steps'>
		<table class='bordered table-results'>
			<thead>
			...
			<tbody>
				<tr class='log' status='fail'>
					<td class='status fail' title='fail' alt='fail'><i class='material-icons'>cancel</i></td>
					<td class='timestamp'>1:56:33 PM</td>
					<td class='step-details'><textarea>org.json.JSONException: End of input at character 0 of
	at org.json.JSONTokener.syntaxError(JSONTokener.java:450)
	at org.json.JSONTokener.nextValue(JSONTokener.java:97)
	at org.json.JSONObject.<init>(JSONObject.java:155)
	at org.json.JSONObject.<init>(JSONObject.java:172)
	at com.dadalong.autotest.httpclient.TestHttpClient.testGet2HttpClient(TestHttpClient.java:60)
	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:62)
	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
	at java.lang.reflect.Method.invoke(Method.java:498)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
				...
				<li class='test displayed active  fail' status='fail' bdd='false' test-id='4'>
					<div class='test-heading'>
						<span class='test-name'>testGetHttpClient</span>
						<span class='test-time'>May 19, 2020 01:56:32 PM</span>
						<span class='test-status right fail'>fail</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>May 19, 2020 01:56:32 PM</span>
	<span class='label end-time'>May 19, 2020 01:56:33 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 0s+552ms</span>
</div>
	<div class='test-steps'>
		<table class='bordered table-results'>
			<thead>
	...
	at org.json.JSONObject.<init>(JSONObject.java:155)
	at org.json.JSONObject.<init>(JSONObject.java:172)
	at com.dadalong.autotest.httpclient.TestHttpClient.testGetHttpClient(TestHttpClient.java:37)
	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:62)
	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
	at java.lang.reflect.Method.invoke(Method.java:498)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
				...
				<li class='test displayed active  fail' status='fail' bdd='false' test-id='5'>
					<div class='test-heading'>
						<span class='test-name'>testPostHttpClient</span>
						<span class='test-time'>May 19, 2020 01:56:33 PM</span>
						<span class='test-status right fail'>fail</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>May 19, 2020 01:56:33 PM</span>
	<span class='label end-time'>May 19, 2020 01:56:33 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 0s+44ms</span>
</div>
	<div class='test-steps'>
		<table class='bordered table-results'>
			<thead>
	...
	at org.json.JSONObject.<init>(JSONObject.java:155)
	at org.json.JSONObject.<init>(JSONObject.java:172)
	at com.dadalong.autotest.httpclient.TestHttpClient.testPostHttpClient(TestHttpClient.java:85)
	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:62)
	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
	at java.lang.reflect.Method.invoke(Method.java:498)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='6'>
					<div class='test-heading'>
						<span class='test-name'>assertTest2</span>
						<span class='test-time'>May 19, 2020 01:56:30 PM</span>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='7'>
					<div class='test-heading'>
						<span class='test-name'>assertTest3</span>
						<span class='test-time'>May 19, 2020 01:56:30 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
...
<div id='exception-view' class='view hide'>
                            ...
                            <div class='exception-content hide'>
                                <div class='exception-tests'>
                                    <table class='bordered table-results'>
                                        ...
                                        <tbody>
                                                    <tr>
                                                        <td>May 19, 2020 01:56:30 PM</td>
                                                        <td class='linked' test-id='1'>assertTest1</td>
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
                        ...
                        <li class='exception displayed active'>
                            <div class='exception-heading'>
                                <span class='exception-name'>java.lang.RuntimeException</span>
                                <span class='exception-count right'><span class='label red lighten-1 white-text'>1</span></span>
                            </div>
                            <div class='exception-content hide'>
                                <div class='exception-tests'>
                                    <table class='bordered table-results'>
                                        ...
                                        <tbody>
                                                    <tr>
                                                        <td>May 19, 2020 01:56:30 PM</td>
                                                        <td class='linked' test-id='2'>logTest1</td>
                                                        <td><pre><pre>java.lang.RuntimeException: 自己运行时的异常
	at com.dadalong.autotest.testng.AssertDemo.logTest1(AssertDemo.java:27)
	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:62)
	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
                        ...
                        <li class='exception displayed active'>
                            <div class='exception-heading'>
                                <span class='exception-name'>org.json.JSONException</span>
                                ...
                                <div class='exception-tests'>
                                    <table class='bordered table-results'>
                                        ...
                                        <tbody>
                                                    <tr>
                                                        <td>May 19, 2020 01:56:30 PM</td>
                                                        <td class='linked' test-id='3'>testGet2HttpClient</td>
                                                        <td><pre><textarea>org.json.JSONException: End of input at character 0 of
	at org.json.JSONTokener.syntaxError(JSONTokener.java:450)
	at org.json.JSONTokener.nextValue(JSONTokener.java:97)
	at org.json.JSONObject.<init>(JSONObject.java:155)
	at org.json.JSONObject.<init>(JSONObject.java:172)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
                                                    ...
                                                    <tr>
                                                        <td>May 19, 2020 01:56:32 PM</td>
                                                        <td class='linked' test-id='4'>testGetHttpClient</td>
                                                        <td><pre><textarea>org.json.JSONException: End of input at character 0 of
	at org.json.JSONTokener.syntaxError(JSONTokener.java:450)
	at org.json.JSONTokener.nextValue(JSONTokener.java:97)
	at org.json.JSONObject.<init>(JSONObject.java:155)
	...
	at org.testng.RemoteTestNGStarter.main(RemoteTestNGStarter.java:123)
                                                    ...
                                                    <tr>
                                                        <td>May 19, 2020 01:56:33 PM</td>
                                                        <td class='linked' test-id='5'>testPostHttpClient</td>
                                                        <td><pre><textarea>org.json.JSONException: End of input at character 0 of
	at org.json.JSONTokener.syntaxError(JSONTokener.java:450)
	at org.json.JSONTokener.nextValue(JSONTokener.java:97)
	at org.json.JSONObject.<init>(JSONObject.java:155)
	...
	<div class='card-panel transparent np-v'>
		...
		<div class='row'>
			...
			<div class='col s2'>
				<div class='card-panel r'>
					Start
					<div class='panel-lead'>May 19, 2020 01:56:30 PM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>End<div class='panel-lead'>May 19, 2020 01:56:33 PM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
					Time Taken
					<div class='panel-lead'>0h 0m 3s+300ms</div>
				</div>
			</div>
		</div>
	</div>
